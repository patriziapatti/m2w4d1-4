...
REQUISITI:
- il tuo algoritmo deve tornare i risultati nella seguente forma (nella forma di oggetto che ha chiave risultato con array e chiave count):
{
...
//console.log (cercaLavori('us','Account'))
...
function aggiungiLavori(){
  ...
  for (let lavoro of lavoriFiltrati.result) {
    ...
    nuovoElemento.innerText =  lavoro.title + " - " + lavoro.location
